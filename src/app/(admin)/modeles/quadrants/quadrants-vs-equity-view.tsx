...
export function QuadrantsVsEquityView({
  rows,
  loading,
  onPick,
  region,
  ...
  const items = useMemo<Item[]>(() => {
    return (rows ?? [])
      ...
      .map((r) => ({ row: r, ve: quadrantsVsEquity(r) }))
      ...
      <div className={cn("space-y-4", loading && "opacity-60 transition-opacity")}>
        ...
        <div id="synthese" className="grid scroll-mt-[var(--model-header-offset,96px)] grid-cols-2 gap-3 lg:grid-cols-4">
          <CountCard
            ...
            desc="Nombre de pays où le portefeuille 4 Quadrants fait mieux que l’indice actions local en rendement, tout en réduisant le risque."
          ...
          <CountCard
            ...
            desc="Nombre de pays où le 4 Quadrants fait presque aussi bien que les actions, mais avec une baisse maximale beaucoup plus faible."
          ...
          <LeaderCard
            ...
            desc="Pays où le 4 Quadrants réduit le plus la perte maximale par rapport à l’indice actions local."
            formula="|Max DD actions| − |Max DD 4Q|"
          ...
          <LeaderCard
            ...
            desc="Pays où le 4 Quadrants améliore le plus le rendement obtenu par unité de risque."
            formula="Sharpe 4Q − Sharpe actions"
          ...
          <div className="mb-2 flex items-center gap-1.5">
            ...
            <Tooltip>
              ...
              <TooltipContent side="top" className="max-w-72">
                Chaque point représente un pays. Le graphique montre si le 4 Quadrants améliore le
                rendement (vertical) et/ou réduit le drawdown (horizontal) par rapport aux actions
        ...
        {/* Carte internationale des profils (charge la géo à la demande) */}
        <Card id="carte" className="scroll-mt-[var(--model-header-offset,96px)] gap-0 p-4">
          ...
          {showMap && (
            <div className="mt-3">
              <QuadrantsVerdictMap rows={items.map((it) => it.row)} region={region} />
            </div>
          )}
        </Card>
      </div>
