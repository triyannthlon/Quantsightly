...
/**
 * Colonnes de la watchlist ETF (pipeline MARKETS).
 * =============================================
 *
 * Layout :
...
const COL_COUNTRY: EtfColumnDef = {
  key: "country",
  label: "Pays\n(Cotation)",
  align: "center",
  cell: (ctx) => <CountryCell {...ctx} />,
};
const COL_CURRENCY: EtfColumnDef = {
  key: "currency",
  label: "Devise",
  align: "center",
...
const COL_SPARKLINE: EtfColumnDef = {
  key: "spk6m",
  label: "6 Mois",
  align: "center",
  width: "w-28",
...
const COL_DIST_52W: EtfColumnDef = {
  key: "d52w",
  label: "Δ sommet 52S",
  align: "right",
