...
export default function VerifyCodeForm() {
  ...
  const { inputsRef, timer, isResending, onSubmit, resendCode } = useVerifyCode(
    email,
    form,
  ); /* appel de useVerifyCode dans hooks */
                      ...
                      {Array.from({ length: 6 }).map((_, i) => (
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            const newCode =
                              field.value.substring(0, i) + value + field.value.substring(i + 1);
