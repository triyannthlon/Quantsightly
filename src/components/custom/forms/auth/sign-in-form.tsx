  ...
  return (
    <Card className="w-full max-w-sm sm:max-w-md md:max-w-lg border-0 shadow-none px-2 sm:px-0">
      <CardHeader className="space-y-2">
        <div className="flex items-center justify-center sm:justify-center h-16">
          <Logo />
        </div>
        <CardDescription className="text-xl sm:text-2xl font-semibold text-foreground text-center sm:text-center">
          Bienvenue
        </CardDescription>
      </CardHeader>
      <CardContent>
        <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6 text-center sm:text-center">
          Veuillez saisir votre adresse e‑mail afin de recevoir votre code de vérification à six
          chiffres.
          <br />
          <em className="text-xs sm:text-sm">
            (N’oubliez pas de vérifier votre dossier de spams.)
          </em>
        </p>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full justify-center h-10 sm:h-12 text-sm sm:text-base"
            >
              Envoyer le code
            </Button>
          </form>
