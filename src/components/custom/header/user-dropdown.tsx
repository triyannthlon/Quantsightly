                            ...
                            return (
                                   <DropdownMenu>
                                    <DropdownMenuTrigger asChild className="cursor-pointer">
                                     <Button variant="ghost" className="h-auto px-0 py-0 bg-transparent hover:bg-transparent focus:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 active:bg-transparent outline-none">
                                      <span className="flex items-center text-sm font-medium">
                                       <Avatar className="mr-3 h-11 w-11">{avatarSrc && <AvatarImage src={avatarSrc} alt={displayName} />}
