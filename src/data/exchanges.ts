...
export const EXCHANGES: Exchange[] = [
  ...
  {
    code: "SEM",
    label: "Stock Exchange of Mauritius",
    countryIso2: "MU",
    currency: "MUR",
    mic: "XMAU",
  },
  ...
  {
    code: "IN",
    label: "Bourse de Mumbai (BSE / NSE)",
    countryIso2: "IN",
    currency: "INR",
    mic: "XBOM",
  },
  ...
  {
    code: "FOREX",
    label: "Marché des changes (Forex)",
    countryIso2: "",
    currency: "",
    mic: "CDSL",
  },
...
export const EXCHANGE_BY_CODE: Record<ExchangeCode, Exchange> = Object.fromEntries(
