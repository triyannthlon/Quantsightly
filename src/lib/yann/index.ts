/**
 * Couche YANN — point d'entrée (barrel)
 * =====================================
 *
 * Structure interne :
...
// ── Watchlist types ───────────────────────────────────────────
export type {
    WatchlistIdentity, CountryLocation, LastPrice,
    Distance52WHigh, Range52W,
    ReturnsWeekdayMultiHorizon, ReturnsCryptoMultiHorizon,
    StockWatchlistRow, EtfWatchlistRow, CryptoWatchlistRow,
    IndexWatchlistRow, ForexWatchlistRow, WatchlistRow,
    RowStatus,
