 ...
 *
 *  - `NormalizedBar` (yann)  : cotation reformatée pour qu'il y en ait
...
export type NormalizedSeries = {
                               ...
                               source : { from: string; to: string }; /* Bornes (au format YYYY-MM-DD) du brut d'origine : - `from` = date du 1er     close réel
