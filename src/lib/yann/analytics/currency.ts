/**
 * Couche YANN — conversion de devises
 * ===================================
 *
 ...
 *  - Une `FxRateSource` est une INTERFACE permettant à yann de demander
...
/************** convertValue *****/
export function convertValue(amount  : number | undefined,
                             from    : string,
                             to      : string,
                             source  : FxRateSource,
                             date   ?: string,
...
/************** convertSeries *****/
export function convertSeries(series : NormalizedSeries,
                              from   : string,
                              to     : string,
                              source : FxRateSource,): NormalizedSeries
      {//convertSeries
      ...
      const bars = series.bars.map((b)=> {
                                                      const rate = source.at(from, to, b.date);
                                                        ...
                                                        if (rate === undefined) return b;   // taux inconnu : on laisse en natif
                                                                                ...
                                                                                return {...b,         close :          b.close * rate,
                                                                                             adjusted_close : b.adjusted_close * rate,};});
